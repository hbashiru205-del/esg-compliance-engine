...
with tab2:
    ...
    if not st.session_state.docs_loaded:
        ...
        st.warning("Enter your Anthropic API key in the sidebar to run the test.")
    else:
...
with tab3:
    ...
    steps = [
        ...
        ("5. Generate","Claude reads only those sections and generates a precise, cited answer."),
